...
If you want to use your VMware Environment then you can follow the xref:VMware_setup.adoc[VMware Setup].
====
...
quay.io/redhat-cop/openshift-virtualization-migration-ee  2.5         1a14e9cef3f7  3 months ago  1.05 GB
----
...
[NOTE]
====
GitLab - Git Credentials to retrieve the Ansible for OpenShift Virtualization Migration Ansible Content Collection

* Login to https://gitlab.consulting.redhat.com/ with sso
* Create Personal Access Token - Edit profile > Access tokens > Personal access tokens > Add new token
* Clone the repository - https://gitlab.consulting.redhat.com/redhat-cop/openshift-virtualization-migration/openshift_virtualization_migration.git[GitLab Repo - openshift_virtualization_migration]
** Provide your username
** Provide your personal access token as password
* Use above credentials as `git_username` and `git_password` in inventory file in future section
====
...
----
$ env | grep -E "^ETX_REPO|^OPENSHIFT_VIRTUALIZATION_MIGRATION_REPO"
ETX_REPO=/home/cloud-user/etx-virt_delivery
OPENSHIFT_VIRTUALIZATION_MIGRATION_REPO=/home/cloud-user/openshift_virtualization_migration
----
...
[NOTE]
====
Create and download your own manifest

* Create a https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.5/html/access_management_and_authentication/assembly-gateway-licensing#proc-create-subscription-allocation_obtain-manifest[subscription allocation]
* https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.5/html/access_management_and_authentication/assembly-gateway-licensing#proc-add-merge-subscriptions[Adding subscriptions to a subscription allocation]
* https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.5/html/access_management_and_authentication/assembly-gateway-licensing#proc-aap-generate-manifest-file[Downloading a manifest file] to your local machine
* In case you are using bastion machine provided by the RHDP then use scp command to copy from your local machine to bastion. For example,

  user-mac:~ user$ scp -P 32688 Downloads/manifest_user-aapsub_20250808T185832Z.zip lab-user@ssh.ocpv07.rhdp.net:aap-manifest.zip

You will get bastion login details from the info tab in demo.
====
