= Product Enablement: OpenShift Virtualization and Migration Lab

Welcome to the OpenShift Virtualization and Migration Lab.
...
* Migrate Virtual Machines from VMware to OpenShift Virtualization using Ansible (Coming Soon)
